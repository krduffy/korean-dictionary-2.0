...
class DbDataManager:
    ...
    @classmethod
    def create_base_user(cls, username):
    ...
    def create_korean_words(cls):
        ...
        for word_data in korean_word_data:
            word = KoreanHeadword.objects.create(
    ...
    def create_all_test_data(cls):
        ...
        user = cls.create_base_user("firstuser")
        second_user = cls.create_base_user("seconduser")
        ...
        return {
            ...
            "regular_user": user,
            "second_regular_user": second_user,
            "staff": staff,
        }
