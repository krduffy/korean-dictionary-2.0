...
class AuthViewsTest(APITestCase):
    ...
    def setUp(self):
      ...
      self.user = User.objects.create_user(username=self.main_username, password=self.main_password)
    ...
    def access_cookie_returned(self, response):
      return 'access' in response.data
    ...
    def test_register_user(self):
      ...
      registration_attempts = [
        # correct usage
        {'username': 'unused', 'password1': 'validpassword',
         'password2': 'validpassword', 'expected_status': status.HTTP_200_OK},
        # username already in use
        {'username': 'testusername', 'password1': 'validpassword',
         'password2': 'validpassword', 'expected_status': status.HTTP_400_BAD_REQUEST},
        # password is too short
        {'username': 'unused', 'password1': 'short',
         'password2': 'short', 'expected_status': status.HTTP_400_BAD_REQUEST},
      ]
      ...
      for attempt in registration_attempts:
        with self.subTest(case=attempt):
          ...
          if attempt['expected_status'] == status.HTTP_200_OK:
            ...
            self.assertTrue(User.objects.filter(username=attempt['username']).exists())
    ...
    def test_login(self):
      login_attempts = [
        ...
        {'username': 'wrongusername', 'password': 'testpassword', 
          'expected_status': status.HTTP_401_UNAUTHORIZED},
        # username missing
    ...
    def test_change_password(self):
      ...
      change_attempts = [
        # correct usage
        {'old_password': 'testpassword', 'new_password1': 'newpassword123',
         'new_password2': 'newpassword123', 'expected_status': status.HTTP_200_OK},
        # provided username incorrect
        {'old_password': 'wrongpassword', 'new_password1': 'newpassword456',
         'new_password2': 'newpassword456', 'expected_status': status.HTTP_400_BAD_REQUEST},
      ]
