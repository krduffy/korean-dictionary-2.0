...
from words.views import (
    KoreanWordSearchResultsView,
    HanjaCharacterSearchResultsView,
    KoreanWordDetailedView,
...
urlpatterns = [
    ...
    path(
        "hanja/search", HanjaCharacterSearchResultsView.as_view(), name="hanja_search"
    ),
    path(
        "hanja/detail/<pk>", HanjaCharacterDetailedView.as_view(), name="hanja_detail"
    ),
