...
from words.tests.fixtures.word_utils_mixin import WordUtilsMixin
...
class HanjaExampleTests(DbDataMixin, WordUtilsMixin, APITestCase):
    ...
    def test_studied_to_top(self):
        self.studied_words_addall(self.regular_user, [self.중국])
    ...
    def test_studied_before_known(self):
        self.known_words_addall(self.regular_user, [self.영국])
        self.studied_words_addall(self.regular_user, [self.한국])
    ...
    def test_known_before_users_that_know(self):
        self.known_words_addall(self.regular_user, [self.영국])
        self.known_words_addall(self.staff, [self.영국])

        self.known_words_addall(self.second_regular_user, [self.한국])
    ...
    def test_users_that_know_before_alphabetical(self):
        self.known_words_addall(self.regular_user, [self.중국])
