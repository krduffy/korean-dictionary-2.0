...
import { PopupBox } from "app/web-components/misc/PopupBox";
import { useCallAPIWeb } from "app/web-hooks/useCallAPIWeb";
import { useHanjaPopupBox } from "app/web-hooks/useHanjaPopupBox";
...
export const HanjaPopupBoxDisplay = ({ character }) => {
